...
source "proxmox" "rocky-linux-9" {
  ...
  # Template Info
  vm_id                = 1001
  vm_name              = "Packer-RL9-Docker"
  template_description = "Rocky Linux 9 template with Docker instaled"
  template_name        = "Rocky9-Docker"
  ...
  # Packer Stuff
  http_directory           = "Rocky9-docker/config"
...
build {
  ...
  provisioner "file" {
      source = "Rocky9-docker/config/99-pve.cfg"
